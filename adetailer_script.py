...
class AfterDetailerScript(scripts.Script):
    ...
    def get_args(self, p, *args_) -> list[ADetailerArgs]:
        ...
        for n, arg_dict in enumerate(args, 1):
            try:
                ...
                print(f"[DEBUG] ADetailer arg_dict received: {arg_dict}")
                print(f"[DEBUG] ADetailer ad_confidence value: {inp.ad_confidence}")
            except ValueError:
    ...
    def get_i2i_p(
        ...
        print(f"[DEBUG] ad_use_cfg_scale: {args.ad_use_cfg_scale}, ad_cfg_scale: {args.ad_cfg_scale}, final cfg_scale: {cfg_scale}")
        print(f"[DEBUG] ad_denoising_strength: {args.ad_denoising_strength}")
    ...
    def _postprocess_image_inner(
        ...
        if is_mediapipe:
            ...
            with change_torch_load():
                ...
                print(f"[DEBUG] Before ultralytics_predict - ad_confidence: {args.ad_confidence}")
