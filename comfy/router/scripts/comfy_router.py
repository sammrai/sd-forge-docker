...
MODEL_SPECS = [
    ...
    },
    {
        "name": "anima",
        "comfy_arch": "Anima",
        # civitdl の stem は "waiANIMA_v10Base10" "anima_turboV11" のように
        # 大文字小文字も区切りもゆれる。ただの r"anima" だと animagine(SDXL) /
        # animal / animated まで拾ってしまうので、直後に小文字が続く語を除く。
        # 直後が大文字や数字の形は残したいので、IGNORECASE はスコープ指定にして
        # 後読みには効かせない。
        ...
        # sampler と denoise はチェックポイント作者の推奨由来:
        # er_sde が作者の既定サンプラー、denoise は 0.35-0.4。
        # **ただし代替との比較実測はしていない。**
        "hr_sampler": "er_sde",
        "hr_scheduler": "simple",
        "hr_steps": 8,
